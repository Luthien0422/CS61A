...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while True:
            ...
            if position >= self.min_range and position <=self.max_range:
                if next_place.entrance!=None and isinstance(next_place,Hive)!=True:
                    if next_place.bees != []:
                        return random_or_none(next_place.bees)
                if isinstance(next_place,Hive):
                    return None
    ...
    def action(self, gamestate):
        ...
        if self.degesting != 0:
            ...
            if self.place.bees != []:
                ...
                self.degesting = self.time_to_digest
        # END Problem 6
